            ...
            <div class="form-row">
                ...
                <div class="col">
                    <table class="table table-condensed table-borderless">
                        <tr>
                            <td><label for="rowsort" class="col-sm-2 col-form-label-sm">rowsort</label></td>
                            <td><input class="form-control form-control-sm" name="rowsort" v-model="rowsort" /></td>
                        </tr>
                        <tr>
                            <td><label for="columnsort" class="col-sm-2 col-form-label-sm">columnsort</label></td>
                            <td><input class="form-control form-control-sm" name="columnsort" v-model="columnsort" /></td>
                        </tr>
                        <tr>
                            <td><label for="login_filter" class="col-sm-2 col-form-label-sm">login_filter</label></td>
                            <td><input class="form-control form-control-sm" name="login_filter" v-model="login_filter" /></td>
                        </tr>
                        <tr>
                            <td><label for="completion_filter" class="col-sm-2 col-form-label-sm">completion_filter</label></td>
                            <td><input class="form-control form-control-sm" name="completion_filter" v-model="completion_filter" /></td>
                        </tr>
                        <tr>
                            <td><label for="remove_button" class="col-sm-2 col-form-label-sm">remove_button</label></td>
                            <td><input class="form-control form-control-sm" name="remove_button" v-model="remove_button" /></td>
                        </tr>
                        <tr>
                            <td><label for="course_type_only" class="col-sm-2 col-form-label-sm">course_type_only</label></td>
                            <td><input class="form-control form-control-sm" name="course_type_only" v-model="course_type_only" /></td>
                        </tr>
                        <tr>
                            <td><label for="ple_only" class="col-sm-2 col-form-label-sm">ple_only</label></td>
                            <td><input class="form-control form-control-sm" name="ple_only" v-model="ple_only" /></td>
                        </tr>
                        <tr>
                            <td><label for="summary_only" class="col-sm-2 col-form-label-sm">summary_only</label></td>
